...
#    for b in t:
#        if label(b) == 'loki':
#            label(b) == lokis_replacement
#        else:
#            return replace_loki_at_leaf(branches(b), lokis_replacement)
...
def closer_city(lat, lon, city_a, city_b):
    ...
    'Bucharest'
    """
    city_origin = make_city('city_origin', lat, lon)
    if distance(city_a, city_origin) <= distance(city_b, city_origin):
...
#        return True
#    else:
#        return [dejavu(b, n - label(b)] for b in branches(t)
    if is_leaf(t):
        return n == label(t)
